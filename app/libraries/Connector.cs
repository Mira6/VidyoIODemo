...
namespace VidyoClient
{
	public class Connector{
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorConnectNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String host, [MarshalAs(UnmanagedType.LPStr)]String token, [MarshalAs(UnmanagedType.LPStr)]String displayName, [MarshalAs(UnmanagedType.LPStr)]String resourceId, OnSuccess onSuccess, OnFailure onFailure, OnDisconnected onDisconnected);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoConnectorConstructNative(ref IntPtr viewId, [MarshalAs(UnmanagedType.I4)]ConnectorViewStyle viewStyle, uint remoteParticipants, [MarshalAs(UnmanagedType.LPStr)]String logFileFilter, [MarshalAs(UnmanagedType.LPStr)]String logFileName, ulong userData);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorEnableDebugNative(IntPtr c, uint port, [MarshalAs(UnmanagedType.LPStr)]String logFilter);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorRegisterLogEventListenerNative(IntPtr c, OnLog onLog, [MarshalAs(UnmanagedType.LPStr)]String filter);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorSendChatMessageNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String message);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorSetAdvancedOptionsNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String options);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorSetCameraNudgeConfigurationNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String cameraNudgeConfig);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorSetCameraPrivacyNative(IntPtr c, Boolean privacy);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoConnectorSetCertificateAuthorityListNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String certificateAuthorityList);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorSetPoolNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String name);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern Boolean VidyoConnectorSetTURNAddressCredentialsNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String turnAddress, uint port, [MarshalAs(UnmanagedType.LPStr)]String username, [MarshalAs(UnmanagedType.LPStr)]String password, [MarshalAs(UnmanagedType.I4)]ConnectorBaseTransportType baseTransport);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern void VidyoConnectorSetWebProxyAddressCredentialsNative(IntPtr c, [MarshalAs(UnmanagedType.LPStr)]String proxyAddress, [MarshalAs(UnmanagedType.LPStr)]String username, [MarshalAs(UnmanagedType.LPStr)]String password);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void OnDynamicParticipantChanged(IntPtr c, IntPtr participants, IntPtr remoteCameras);
		...
		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoConnectorOnDynamicParticipantChangedGetremoteCamerasArrayNative(IntPtr obj, ref int size);

		[DllImport(importLib, CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr VidyoConnectorOnDynamicParticipantChangedFreeremoteCamerasArrayNative(IntPtr obj, int size);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void OnWebProxyCredentialsRequest(IntPtr c);
		...
		public interface IRegisterParticipantEventListener{
			...
			void OnDynamicParticipantChanged(List<Participant> participants, List<RemoteCamera> remoteCameras);
		...
		public Connector(IntPtr viewId, ConnectorViewStyle viewStyle, uint remoteParticipants, String logFileFilter, String logFileName, ulong userData){
			objPtr = VidyoConnectorConstructNative(ref viewId, viewStyle, remoteParticipants, logFileFilter, logFileName, userData);
		...
		public Boolean Connect(String host, String token, String displayName, String resourceId, IConnect _iIConnect){
			...
			Boolean ret = VidyoConnectorConnectNative(objPtr, host, token, displayName, resourceId, _mOnSuccess, _mOnFailure, _mOnDisconnected);
		...
		public Boolean EnableDebug(uint port, String logFilter){
			...
			Boolean ret = VidyoConnectorEnableDebugNative(objPtr, port, logFilter);
		...
		public Boolean RegisterLogEventListener(IRegisterLogEventListener _iIRegisterLogEventListener, String filter){
			...
			Boolean ret = VidyoConnectorRegisterLogEventListenerNative(objPtr, _mOnLog, filter);
		...
		public Boolean SendChatMessage(String message){
			...
			Boolean ret = VidyoConnectorSendChatMessageNative(objPtr, message);

			return ret;
		}
		public Boolean SetAdvancedOptions(String options){

			Boolean ret = VidyoConnectorSetAdvancedOptionsNative(objPtr, options);

			return ret;
		}
		public Boolean SetCameraNudgeConfiguration(String cameraNudgeConfig){

			Boolean ret = VidyoConnectorSetCameraNudgeConfigurationNative(objPtr, cameraNudgeConfig);
		...
		public void SetCertificateAuthorityList(String certificateAuthorityList){
			...
			VidyoConnectorSetCertificateAuthorityListNative(objPtr, certificateAuthorityList);
		}
		...
		public Boolean SetPool(String name){
			...
			Boolean ret = VidyoConnectorSetPoolNative(objPtr, name);
		...
		public Boolean SetTURNAddressCredentials(String turnAddress, uint port, String username, String password, ConnectorBaseTransportType baseTransport){
			...
			Boolean ret = VidyoConnectorSetTURNAddressCredentialsNative(objPtr, turnAddress, port, username, password, baseTransport);
		...
		public void SetWebProxyAddressCredentials(String proxyAddress, String username, String password){
			...
			VidyoConnectorSetWebProxyAddressCredentialsNative(objPtr, proxyAddress, username, password);
		}
...
#endif
		private static void OnDynamicParticipantChangedDelegate(IntPtr c, IntPtr participants, IntPtr remoteCameras){
			...
			List<RemoteCamera> csRemoteCameras = new List<RemoteCamera>();
			int nRemoteCamerasSize = 0;
			IntPtr nRemoteCameras = VidyoConnectorOnDynamicParticipantChangedGetremoteCamerasArrayNative(remoteCameras, ref nRemoteCamerasSize);
			int nRemoteCamerasIndex = 0;
			while (nRemoteCamerasIndex < nRemoteCamerasSize) {
				RemoteCamera csTremoteCameras = null;
				if(Marshal.ReadIntPtr(nRemoteCameras + (nRemoteCamerasIndex * Marshal.SizeOf(nRemoteCameras))) != IntPtr.Zero){
					if(RemoteCamera.VidyoRemoteCameraGetUserDataNative(Marshal.ReadIntPtr(nRemoteCameras + (nRemoteCamerasIndex * Marshal.SizeOf(nRemoteCameras)))) == IntPtr.Zero)
						csTremoteCameras = new RemoteCamera(Marshal.ReadIntPtr(nRemoteCameras + (nRemoteCamerasIndex * Marshal.SizeOf(nRemoteCameras))));
					else{
						GCHandle objHandle = (GCHandle)RemoteCamera.VidyoRemoteCameraGetUserDataNative(Marshal.ReadIntPtr(nRemoteCameras + (nRemoteCamerasIndex * Marshal.SizeOf(nRemoteCameras))));
						csTremoteCameras = (RemoteCamera)objHandle.Target;
					}
				}
				csRemoteCameras.Add(csTremoteCameras);
				nRemoteCamerasIndex++;
			}

			if(_mIRegisterParticipantEventListener != null)
				_mIRegisterParticipantEventListener.OnDynamicParticipantChanged(csParticipants, csRemoteCameras);
			VidyoConnectorOnDynamicParticipantChangedFreeremoteCamerasArrayNative(nRemoteCameras, nRemoteCamerasSize);
...
#endif
		private static void OnWebProxyCredentialsRequestDelegate(IntPtr c){
			if(_mIRegisterWebProxyEventListener != null)
				_mIRegisterWebProxyEventListener.OnWebProxyCredentialsRequest();
		}
#if __IOS__
